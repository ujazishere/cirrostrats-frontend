...
const useInputHandlers = () => {
  ...
  const [showingMultipleAirports, setShowingMultipleAirports] = useState(false);
  ...
  const showMultipleAirportsMessage = () => {
    ...
    // Set message content
    messageElement.textContent = "Multiple airports found. Please select one from the dropdown.";
