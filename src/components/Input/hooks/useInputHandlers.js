...
const handleSubmit = (e, submitTerm, userEmail, suggestions = []) => {
    ...
    if (typeof submitTerm === 'object' && submitTerm.label) {
        ...
        // NEW LOGIC: Check if there are any suggestions currently visible in the dropdown for `flight` type
          // Check if the visible suggestions matches the submit term exactly for digits (for flights)
