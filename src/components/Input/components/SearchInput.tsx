...
export default function SearchInput({ userEmail }: SearchInputProps) {
  ...
  const { filteredSuggestions, refreshRecentSearches } = useSearchSuggestions(
    userEmail,
    true,
    inputValue,
    dropOpen,
      ...
      <div className="search-wrapper">
        <Autocomplete
          ...
          onInputChange={(event, newInputValue) => {
            handleInputChange(event, newInputValue, userEmail);
          }}
          // This function is called when a dropdown suggestion is selected
          onChange={(e, submitTerm) => {
                  ...
                  endAdornment: (
                    <div className="search-icon-container">
                      <button
                        ...
                        } // Call the handleSubmit function on click
                      >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      color: option.isRecent ? "purple" : "inherit",
                      textAlign: "left", // Change to purple if recent
